...
VALUES
  ...
  ('Bertemu Teman Baru', 'Latihan memulai percakapan dengan teman baru.', 'Halo! Aku Sova 😊 Hari ini kita belajar berkenalan dengan teman baru. Siapa namamu?', '["Namaku Bimo.", "Senang bertemu denganmu.", "Apa hobimu?"]'::jsonb, 2, true),
  ('Membeli Makanan di Kantin', 'Latihan meminta bantuan dan memesan makanan dengan sopan.', 'Halo, aku penjaga kantin. Kamu ingin membeli apa hari ini?', '["Saya mau roti, Bu.", "Berapa harganya?", "Terima kasih."]'::jsonb, 3, true),
  ('Berbicara dengan Guru', 'Latihan bertanya kepada guru ketika membutuhkan bantuan.', 'Halo Bimo, kelihatannya kamu ingin bertanya. Apa yang ingin kamu sampaikan?', '["Bu, boleh saya bertanya?", "Saya belum paham.", "Tolong bantu saya."]'::jsonb, 4, true),
  ('Presentasi di Depan Kelas', 'Latihan memperkenalkan ide dengan kalimat pendek dan jelas.', 'Sekarang giliranmu berbicara di depan kelas. Kamu bisa mulai pelan-pelan.', '["Halo teman-teman.", "Saya ingin bercerita.", "Terima kasih sudah mendengarkan."]'::jsonb, 5, true),
  ('Pergi ke Dokter Gigi', 'Latihan menyampaikan rasa takut dan mengikuti instruksi.', 'Halo, aku dokter gigi. Apa yang kamu rasakan hari ini?', '["Saya agak takut.", "Gigi saya sakit.", "Boleh dijelaskan dulu?"]'::jsonb, 6, true),
